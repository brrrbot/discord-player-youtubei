...
import Innertube, { ClientType, Platform, Player, Types } from "youtubei.js";
...
export async function decipherManifestUrl(url: string, player: Player, poToken: string): Promise<string> {
    ...
    console.log(`decipheredUrlObject: ${decipheredUrlObject.toString()}`);
